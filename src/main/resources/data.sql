...
('Naranja', 50.0, 'g', 150.0, 8.0, 4.0, 2.0, 2.0, 18.0, 4.0, 2.0, 10.0, 400.0, 200.0, (SELECT id_category FROM categories WHERE category_name = 'Frutas')),
('Leche desnatada del lidl', 200.0, 'ml', 100.0, 6.0, 3.0, 2.0, 1.0, 15.0, 2.0, 1.0, 5.0, 300.0, 100.0, (SELECT id_category FROM categories WHERE category_name = 'Lácteos'));
...
-- -- Insertar los ingredientes de las recetas
-- INSERT INTO recipes_ingredients (recipe_id, ingredient_id, weight, unit)
-- VALUES
-- (1, 1, 100.0, 'g'), -- Ensalada de Tomate: Lechuga
-- (1, 2, 50.0, 'g'),  -- Ensalada de Tomate: Naranja
-- (2, 2, 200.0, 'ml'),-- Batido de Manzana: Leche desnatada del lidl
-- (3, 1, 100.0, 'g');-- Pollo al Horno: Lechuga